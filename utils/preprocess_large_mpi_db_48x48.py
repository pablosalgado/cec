...
# a 768x576 RBG image. This scripts extracts the face, resizes it to 48x48,
...
# https://unir-tfm-cec.s3.us-east-2.amazonaws.com/cec-data-48x48.tar.gz
...
# Successful face extraction
success = []

# Failed face extraction
failure = []

# List of images not processed
...
try:
    ...
    print(f'Successful face extraction count: {len(success)}')
    print(f'Failed face extraction count: {len(failure)}')