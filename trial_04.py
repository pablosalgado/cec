...
#
# https://unir-tfm-cec.s3.us-east-2.amazonaws.com/trial04.tar.gz
...
def train():
    tf.keras.utils.get_file(
        fname='cec-videos-extracted-augmented.tar.gz',
        origin='https://unir-tfm-cec.s3.us-east-2.amazonaws.com/cec-videos-extracted-augmented.tar.gz',
        extract=True
    )
